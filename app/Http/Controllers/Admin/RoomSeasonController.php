...
class RoomSeasonController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        if ($request->parent){
            ...
            session(['parent_id' => $request->parent]);
        }else{
            session(['parent_id' => false]);
        ...
        if (session('parent_id')){
            $room = Room::find(session('parent_id'));
            $hotel_id = $room->hotel->id;
        }
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','hotel_id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            if (session('return_url')){
                return redirect(session('return_url'))->with([
