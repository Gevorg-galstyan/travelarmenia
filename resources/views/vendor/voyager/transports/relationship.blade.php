	...
	@if(class_exists($options->model))
		...
		@elseif($options->type == 'hasMany')
			...
			@else
				...
				@if(isset($query))
					@if($options->model == 'App\Models\TransportPricing')
						<a href="/admin/transport-pricings/create?parent={{$dataTypeContent->id}}" class="btn btn-success" title="Add Season"><i
							...
							<table class="table">
								...
								@foreach($query as $i => $query_res)
									<tr>
										...
										<td>
											<a href="/admin/transport-pricings/{{$query_res->id}}/edit?parent={{$query_res->transport_id}}"
											   class="btn btn-info">
												Edit
											</a>
										</td>
