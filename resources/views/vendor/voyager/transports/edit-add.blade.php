                    ...
                    <!-- CSRF TOKEN -->
                        ...
                        <!-- Adding / Editing -->
                            ...
                            <!-- GET THE DISPLAY OPTIONS -->
                                ...
                                @else
                                    <div class="form-group  @if($row->type == 'hidden') hidden @endif col-md-{{ $display_options->width or 3 }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        {{ $row->slugify }}
                                        <h4 class="text-center">{{ $row->display_name }}</h4>
                                        @include('voyager::multilingual.input-hidden-bread-edit-add')
                                        @if($row->type == 'relationship')
                                            @include('vendor.voyager.transports.relationship')
                                        @else
                                            @if($row->type == 'multiple_images')
                                                @include('vendor.voyager.transports.multiple_images')
                                            @else
