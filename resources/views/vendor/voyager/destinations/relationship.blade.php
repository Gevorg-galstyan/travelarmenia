    ...
    @if(class_exists($options->model))
        ...
        @elseif($options->type == 'hasMany')
            ...
            @else
                ...
                @if(isset($query))
                    @if($options->model == 'App\Models\DestinationImage')
                        <a href="/admin/destination-images/create?parent={{$dataTypeContent->id}}" class="btn btn-success"
                           title="Add destination-images"><i
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($query as $i => $query_res)
                                    <tr>
                                        <td>{{$i + 1}}</td>
                                        <td>{{ $query_res->image_name }}</td>
                                        <td>
                                            <a href="/admin/destination-images/{{$query_res->id}}/edit?parent={{$query_res->destination_id}}"
                                               class="btn btn-info">
                                                Edit
                                            </a>
                                        </td>
